...
class TestRemoveDependency:
    ...
    @pytest.mark.asyncio
    async def test_remove_dependency_success(self, mock_find_root, mock_check_uv, mock_run_uv, temp_project_with_pyproject):
    ...
    @patch("uv_mcp.actions.find_uv_project_root")
    @pytest.mark.asyncio
    async def test_remove_dev_dependency(self, mock_find_root, mock_check_uv, mock_run_uv, temp_project_with_pyproject):
